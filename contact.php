...
<html>
    ...
    <body>
        ...
        <div id="menu">
        <a href="index.php"> <!-- at the time of creating, this way is somehow crossbrowser safer than just implementing an svg-file... -->
	        ...
	        <div id="menuas">
				...
				<div class="menuitem dropTheShadow" id="menuKontakt"><a href="#">CONTACT</a></div>
