...
<g><path fill="#FF00FF" d="M270.5,57.7c-0.4-12.3-2-26.2-1.6-35.6c0.2-7.7,1.4-11.7,0.7-15.7c-0.6-3.6-6.5-7.4-12.9-6.2
	...
	z M324.8,114.1C323.8,114.1,326.4,114.2,324.8,114.1L324.8,114.1z"/>
        	...
        	<div id="menuas">
			<div class="menuitem dropTheShadow"><a href="javascript:gallery()">GALLERY</a></div>
			<div class="menuitem dropTheShadow"><a href="javascript:gallery()">KONTAKT</a></div>
			<div class="menuitem dropTheShadow"><a href="javascript:gallery()">FACEBOOK</a></div>
			<div class="menuitem dropTheShadow"><a href="javascript:gallery()">INSTAGRAM</a></div>
			</div>
		</div>
